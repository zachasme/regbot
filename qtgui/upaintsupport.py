...
class ControlPaintSpace(PaintSupport):
  ...
  def paintEvent(self, QPaintEvent):
    ...
    paint.drawLine(p2BalVel, QtCore.QPoint(self.ui.frame_ctrlWallVel.x(), p2BalVel.y())) # from turn to mix
    ...
    paint.drawLine(QtCore.QPoint(p1MisX, p2BalVel.y()), QtCore.QPoint(self.ui.frame_ctrlBalVel.x(), p2BalVel.y()))
    ...
    paint.drawLine(QtCore.QPoint(p2PosX, self.ui.frame_ctrlPos.y()), QtCore.QPoint(p2PosX, p2BalVelY))
    self.paintArrow(paint, p2PosX, p2BalVelY, 1, col)
